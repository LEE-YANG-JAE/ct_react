...
export default class Excercise5 extends React.Component {
	// 전역 변수
	...
	// 입력 변화
	inputChange = (e: any) => {
		const financialGoal = e.target.validity.valid ? e.target.value : 0;
		this.setState({ [e.target.name]: financialGoal });
	};
